...
struct EqualTo
{
    LL_INLINE bool operator()(const T& a, const T& b) const
    {
...
// Workaround for "deprecated builtins" warnings with clang v15+. HB
...
template <class... Ts>
LL_INLINE void AssertHashEnabled
()
{
...
#define PHMAP_INTERNAL_INLINE_CONSTEXPR(type, name, init) \
  ...
  LL_INLINE constexpr ::phmap::internal::identity_t<type> name = init
...
static LL_INLINE void ThrowStdLogicError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::logic_error, what_arg);
}
static LL_INLINE void ThrowStdLogicError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::logic_error, what_arg);
}
static LL_INLINE void ThrowStdInvalidArgument(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::invalid_argument, what_arg);
}
static LL_INLINE void ThrowStdInvalidArgument(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::invalid_argument, what_arg);
}

static LL_INLINE void ThrowStdDomainError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::domain_error, what_arg);
}
static LL_INLINE void ThrowStdDomainError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::domain_error, what_arg);
}

static LL_INLINE void ThrowStdLengthError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::length_error, what_arg);
}
static LL_INLINE void ThrowStdLengthError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::length_error, what_arg);
}

static LL_INLINE void ThrowStdOutOfRange(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::out_of_range, what_arg);
}
static LL_INLINE void ThrowStdOutOfRange(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::out_of_range, what_arg);
}

static LL_INLINE void ThrowStdRuntimeError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::runtime_error, what_arg);
}
static LL_INLINE void ThrowStdRuntimeError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::runtime_error, what_arg);
}

static LL_INLINE void ThrowStdRangeError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::range_error, what_arg);
}
static LL_INLINE void ThrowStdRangeError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::range_error, what_arg);
}

static LL_INLINE void ThrowStdOverflowError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::overflow_error, what_arg);
}

static LL_INLINE void ThrowStdOverflowError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::overflow_error, what_arg);
}

static LL_INLINE void ThrowStdUnderflowError(const std::string& what_arg) {
  PHMAP_THROW_IMPL_MSG(std::underflow_error, what_arg);
}

static LL_INLINE void ThrowStdUnderflowError(const char* what_arg) {
  PHMAP_THROW_IMPL_MSG(std::underflow_error, what_arg);
}

static LL_INLINE void ThrowStdBadFunctionCall() {
  PHMAP_THROW_IMPL(std::bad_function_call);
}

static LL_INLINE void ThrowStdBadAlloc() {
...
LL_INLINE std::nullptr_t RawPtr(std::nullptr_t) { return nullptr; }
...
LL_INLINE char* GetDataImpl(std::string& s,  // NOLINT(runtime/references)
                         int) noexcept {
  return &s[0];
}
...
// ----------------------------------------------------------------------------
LL_INLINE void SanitizerPoisonMemoryRegion(const void* m, size_t s) {
#ifdef ADDRESS_SANITIZER
...
LL_INLINE void SanitizerUnpoisonMemoryRegion(const void* m, size_t s) {
#ifdef ADDRESS_SANITIZER
...
template <typename T>
LL_INLINE void SanitizerPoisonObject(const T* object) {
    SanitizerPoisonMemoryRegion(object, sizeof(T));
}

template <typename T>
LL_INLINE void SanitizerUnpoisonObject(const T* object) {
...
// reference.
template <typename T>
LL_INLINE const T& ts_unchecked_read(const T& v) PHMAP_NO_THREAD_SAFETY_ANALYSIS {
    return v;
}

template <typename T>
LL_INLINE T& ts_unchecked_read(T& v) PHMAP_NO_THREAD_SAFETY_ANALYSIS {
    return v;
}
...
#if PHMAP_USE_BOOST_MUTEX && defined(BOOST_THREAD_LOCK_OPTIONS_HPP)
...
public:
    ...
    LL_INLINE bool try_lock() { return true; }
    LL_INLINE void lock_shared() {}
    LL_INLINE void unlock_shared() {}
    LL_INLINE bool try_lock_shared() { return true; }
};
...
public:
    ...
    struct DoNothing
    {
        ...
        LL_INLINE DoNothing() noexcept {}
        LL_INLINE explicit DoNothing(mutex_type& ) noexcept {}
        LL_INLINE explicit DoNothing(mutex_type& , mutex_type&) noexcept {}
        LL_INLINE DoNothing(mutex_type&, phmap::adopt_lock_t) noexcept {}
        LL_INLINE DoNothing(mutex_type&, phmap::defer_lock_t) noexcept {}
        LL_INLINE DoNothing(mutex_type&, phmap::try_to_lock_t) {}
        template<class T> explicit LL_INLINE DoNothing(T&&) {}
        LL_INLINE DoNothing& operator=(const DoNothing&) { return *this; }
        LL_INLINE DoNothing& operator=(DoNothing&&) noexcept { return *this; }
        LL_INLINE void swap(DoNothing &)  noexcept {}
        LL_INLINE bool owns_lock() const noexcept { return true; }
        LL_INLINE void lock() {}
        LL_INLINE void unlock() {}
        LL_INLINE void lock_shared() {}
        LL_INLINE void unlock_shared() {}
        LL_INLINE bool switch_to_unique() { return false; }
    };
...
// --------------------------------------------------------------------------
#if defined(_MSC_VER) && defined(SRWLOCK_INIT) && 0	// Disabled (broken). HB
...
// --------------------------------------------------------------------------
#if PHMAP_USE_BOOST_MUTEX && defined(BOOST_THREAD_SHARED_MUTEX_HPP)
...
#endif // PHMAP_USE_BOOST_MUTEX && defined(BOOST_THREAD_SHARED_MUTEX_HPP)
