...
#ifndef PHMAP_NO_MIXING
// ---------------------------------------------------------------
// ---------------------------------------------------------------
template<int n>
struct phmap_mix
{
    LL_INLINE size_t operator()(size_t) const;
};

template<>
struct phmap_mix<4>
{
    LL_INLINE size_t operator()(size_t a) const
    {
...
#endif // PHMAP_NO_MIXING

// --------------------------------------------
template<int n>
struct fold_if_needed
{
    LL_INLINE size_t operator()(uint64_t) const;
};

template<>
struct fold_if_needed<4>
{
    LL_INLINE size_t operator()(uint64_t a) const
    {
...
struct Hash
{
    ...
    LL_INLINE size_t _hash(const T& val) const
    {
    ...
    LL_INLINE size_t operator()(const T& val) const
    {
        return _hash<T>(val);
    }
};
...
struct Hash<T *>
{
    LL_INLINE size_t operator()(const T *val) const noexcept
    {
...
{
    LL_INLINE size_t operator()(bool val) const noexcept
...
{
    LL_INLINE size_t operator()(char val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(signed char val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(unsigned char val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(wchar_t val) const noexcept
    { return static_cast<size_t>(val); }
};
#endif
...
{
    LL_INLINE size_t operator()(int16_t val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(uint16_t val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(int32_t val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(uint32_t val) const noexcept
    { return static_cast<size_t>(val); }
};
...
{
    LL_INLINE size_t operator()(int64_t val) const noexcept
...
{
    LL_INLINE size_t operator()(uint64_t val) const noexcept
...
{
    LL_INLINE size_t operator()(float val) const noexcept
    {
...
{
    LL_INLINE size_t operator()(double val) const noexcept
    {
        // -0.0 and 0.0 should return same hash
...
public:
    ...
    LL_INLINE static H combine(H state) { return state; }
};

template <typename H>
template <typename T, typename... Ts>
LL_INLINE H HashStateBase<H>::combine(H seed, const T& v, const Ts&... vs)
{
...
struct Hash<std::pair<T1, T2>> {
    LL_INLINE size_t operator()(std::pair<T1, T2> const& p) const noexcept {
...
struct Hash<std::tuple<T...>> {
    LL_INLINE size_t operator()(std::tuple<T...> const& t) const noexcept {
...
private:
    template<size_t I = 0, class ...P>
        ...
        LL_INLINE _hash_helper(const std::tuple<P...> &) const noexcept { return 0; }

    template<size_t I = 0, class ...P>
    typename std::enable_if<I < sizeof...(P), size_t>::type
    LL_INLINE _hash_helper(const std::tuple<P...> &t) const noexcept {
