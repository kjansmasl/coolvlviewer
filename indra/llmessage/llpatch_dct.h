...
// Code Values
constexpr U8 ZERO_CODE	= 0x0;
constexpr U8 ZERO_EOB = 0x2;
constexpr U8 POSITIVE_VALUE = 0x6;
constexpr U8 NEGATIVE_VALUE = 0x7;

constexpr S8 NORMAL_PATCH_SIZE	= 16;
constexpr S8 LARGE_PATCH_SIZE = 32;

constexpr U8 END_OF_PATCHES = 97;
...
//	U32	patchids;		// 2 = 10 (actually only uses 10 bits for 256m sims, 5 for each)
//} LLPatchHeader;
class LLPatchHeader
{
public:
