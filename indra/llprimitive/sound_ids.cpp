...
const LLUUID SND_CHIRP					("00000000-0000-0000-0000-000000000106");
const LLUUID SND_CHIRP2					("828a9526-175b-455d-8af0-0e3c0fb602b2");
const LLUUID SND_CHIRP3					("f99772d6-1ce6-4a39-a28b-06d26c94c9e3");
const LLUUID SND_CHIRP4					("54472ca4-7fc9-42cb-b7d5-99ad5b12bd50");
const LLUUID SND_CHIRP5					("2929964f-fac5-40d7-9179-2864a8fa9ace");
const LLUUID SND_CHIRPDEAD				("9abff1d3-863a-4e04-bd83-3834fd7fcff4");
...
const LLUUID SND_STEP_ON_LAND			("e8af4a28-aa83-4310-a7c4-c047e15ea0df");
...
// OpenSIM only provides/uses one collision sound...
const LLUUID SND_OPENSIM_COLLISION		("be7295c0-a158-11e1-b3dd-0804204c9a66");
