...
// *NOTE: Do not put the actual IDs in this file - otherwise the symbols and
// values will be copied into every .o/.obj file and increase link time.
...
extern const LLUUID SND_STEP_ON_LAND;
...
extern const LLUUID SND_OPENSIM_COLLISION;
