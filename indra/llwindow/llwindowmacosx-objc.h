...
GLViewRef createOpenGLView(NSWindowRef window, unsigned int samples,
						   bool vsync, bool core_gl);
...
// This is largely for easier interop between Obj-C and C++ (at least in the
// viewer's case due to the BOOL vs. BOOL conflict)
