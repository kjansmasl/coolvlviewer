...
extern "C"
{
	LLSYMEXPORT int LLPluginInitEntryPoint(LLPluginInstance::sendMessageFunction host_send_func,
										   void* host_user_data,
 ...
 *            plugin loader shell
 * @param[in] host_user_data Message data for messages from plugin to plugin
 *            loader shell
 * @param[out] plugin_send_func Function for plugin to receive messages from
 *             plugin loader shell
...
LLSYMEXPORT int LLPluginInitEntryPoint(LLPluginInstance::sendMessageFunction host_send_func,
									   ...
									   void** plugin_user_data)
{
	return init_media_plugin(host_send_func, host_user_data, plugin_send_func,
							 plugin_user_data);
}

#if LL_WINDOWS	//#ifdef WIN32
