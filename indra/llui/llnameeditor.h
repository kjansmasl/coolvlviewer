...
class LLNameEditor final : public LLLineEditor
{
public:
	...
	LLNameEditor(const std::string& name, const LLRect& rect,
				 ...
				 const LLFontGL* glfont = NULL, S32 max_text_length = 254,
				 void (*commit_cb)(LLUICtrl*, void*) = NULL,
				 void (*keystroke_cb)(LLLineEditor*, void*) = NULL,
				 void (*focus_lost_cb)(LLFocusableElement*, void*) = NULL,
				 void* userdata = NULL, LLLinePrevalidateFunc pfunc = NULL);

	~LLNameEditor() override;
	...
	typedef fast_hset<LLNameEditor*> nameeditor_list_t;

private:
	static nameeditor_list_t sInstances;
