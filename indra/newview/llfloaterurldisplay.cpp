...
{	
	mFactoryMap["place_details_panel"] = LLCallbackMap(LLFloaterURLDisplay::createPlaceDetail,
													   this);
											...
											const LLVector3& pos_local)
{
	...
	mPlacePanel->displayParcelInfo(pos_local, landmark_asset_id,
								   landmark_item_id, region_id, pos_global);
