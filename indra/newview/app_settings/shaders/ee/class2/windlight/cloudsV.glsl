...
void main()
{
    ...
    if (rel_pos.y < 0.)
    {
        altitude_blend_factor = 0;  // SL-11589 Fix clouds drooping below horizon. Not yet in LL's release viewer. HB
    ...
    vec4 sunlight = sunlight_color;  // SL-14707 reset color -- Clouds are unusually dim in EEP
    vec4 light_atten;
