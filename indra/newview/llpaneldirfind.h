...
class LLPanelDirFind final : public LLPanelDirBrowser
{
public:
	LLPanelDirFind(const std::string& name, HBFloaterSearch* floater);
	...
	static void onCommitScope(LLUICtrl* ctrl, void* userdata);

private:
	LLSearchEditor*	mSearchEditor;
};

#endif	// LL_LLPANELDIRFIND_H
