...
class LLFloaterSearchReplace final
:	public LLFloater,
	public LLFloaterSingleton<LLFloaterSearchReplace>
{
	friend class LLUISingleton<LLFloaterSearchReplace,
...
private:
	...
	LLFloaterSearchReplace(const LLSD&);
